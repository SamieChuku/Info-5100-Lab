 ...
 * @author samps
 */
public class Lab7_JDBCAssignmentJFrame extends javax.swing.JFrame {

    /**
     * Creates new form MainJFrame
     */
    public Lab7_JDBCAssignmentJFrame() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lab7_JDBCAssignmentJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lab7_JDBCAssignmentJFrame().setVisible(true);
            }
        });
    }
